...
const ProductCard = () => {
    ...
    const handleAddToCart = (product: { id: string; image: string | StaticImageData}) => {
        // @ts-ignore
                ...
                {products.map((product) => (
                    ...
                    >
                        ...
                        <div className="p-4">
                            ...
                            <Link href={'/cart'}>
                                <button
                                    className="mt-4 w-full bg-brown-500 text-[#daa520] text-sm font-medium py-2 px-4 rounded hover:bg-brown-600 transition duration-200"
